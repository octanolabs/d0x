<template>
  <v-layout class="text-center">
    <v-flex class="pa-6">
      ...
      <p>
        Octano d0x is an
        <a href="https://open-rpc.org/beginners/" target="_blank">OpenRPC</a>
        interface built using
        <a href="https://vuejs.org/" target="_blank">Vue.js</a>.
      </p>
      <p>
        Select an API in the dropdown menu above, get started on a
        <router-link :to="{ name: 'Edit', params: { apiId: 'custom' } }"
          >new OpenRPC document</router-link
        >, or get involved on
        <a href="https://github.com/octanolabs/d0x" target="_blank">Github</a>.
      </p>
      ...
      >
        <v-carousel-item class="ma-0 pa-0" v-for="(item, i) in items" :key="i">
          <img :src="require('../assets/screenshots/' + item)" width="100%" />
        </v-carousel-item>
      </v-carousel>
      <v-flex>
